...
public class MenuScene extends Scene{
    ...
    public MenuScene(KL keyListener, ML mouseListener) {
        ...
        titleRect = new Rect(500, 100, 300, 100);
        playRect = new Rect(600, 280, 150, 70);
        exitRect = new Rect(600, 355,130,55);
    ...
    public void draw(Graphics g) {
        g.setColor(new Color(39, 65, 179, 174));
        g.fillRect(0, 0, Contants.SCREEN_WIDTH, Contants.SCREEN_HEIGHT) ;
